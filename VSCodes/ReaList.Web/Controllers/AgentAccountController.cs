...
namespace ReaList.Web.Controllers
{
    public class AgentAccountController : Controller
    {
        ...
        public AgentAccountController(IAgentAccountDataAccess dataAccess)
        {
...
<body class='respond' leftmargin='0' topmargin='0' marginwidth='0' marginheight='0'>
                                            ...
                                            <tr>
                                                <td align = 'left' style='color: #888888; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 23px;'
                                                    ...
                                                    <div style = 'color: #333333; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; font-weight: 600; mso-line-height-rule: exactly; line-height: 23px;'>
                                                        ...
                                                        Email us: <br/> <a href = 'mailto:' style='color: #888888; font-size: 14px; font-family: 'Hind Siliguri', Calibri, Sans-serif; font-weight: 400;'>contact @benilde.realist@gmail.com</a>
    ...
    <!-- end footer ====== -->
        ...
        public IActionResult Register(AgentAccountModel model, string message)
        {       
        ...
        [HttpPost]
        public async Task<IActionResult> SaveRegister(AgentAccountModel model)
        {
            if (await _dataAccess.IsEmailExists(model.Email))
            {
                var errorMessage = "Registration Failed. Email already exists!";
                ModelState.AddModelError("Email", errorMessage);
                return RedirectToAction("Register", "AgentAccount", new { message = errorMessage });
            }
            ...
            SendVerificationLinkEmail(model.Email, activationCode, "Agent", "VerifyCode", HttpContext);
        ...
        [HttpGet]
        public async Task<IActionResult> GetAll() => Ok(await _dataAccess.GetAllAgentAccount());
        [HttpGet]
        public async Task<IActionResult> GetSpecific(int id) => Ok(await _dataAccess.GetSpecificAgentAccount(id));
    }
}
